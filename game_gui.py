...
class Board(object):
    # The Board() class simulates the game board.
    
    # an integer flag to represent an empty slot in the board
    EMPTY_SLOT = 0
...
class GUI(tk.Frame):
    ...
    def __init__(self, alg_fn_map, master=None):
        ...
        self.master.title("Adversarial Search -- EECS 3401 York University")
